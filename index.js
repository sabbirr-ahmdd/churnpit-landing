...
document.querySelectorAll('a[href="#cta"]').forEach((btn) => {
    btn.addEventListener("click", () => {
        trackEvent("cta_click", {
            location: btn.textContent.trim().toLowerCase().replace(/\s+/g, " ")
        });
    });
});

// Track navigation intent separately from primary CTA clicks.
document.querySelectorAll('a[href="#features"], a[href="#how-it-works"], a[href="#pricing"], a[href="#faq"], a[href="#request"]').forEach((link) => {
...
const featureBtnText = featureBtn ? featureBtn.textContent : "Submit request";

const waitlistForm = document.getElementById("waitlist-form");
const waitlistFormMsg = document.getElementById("waitlist-form-msg");
const waitlistBtn = document.getElementById("waitlist-btn");
const waitlistBtnText = waitlistBtn ? waitlistBtn.textContent : "Get early access";
...
if (featureForm) {
    featureForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                trackEvent("feature_request", { method: "formspree" });
...
if (waitlistForm) {
    waitlistForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                trackEvent("waitlist_signup", { method: "formspree" });
